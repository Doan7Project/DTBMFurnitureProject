...
use App\Http\Requests\Menu\UpdateRegisterRequest;
...
class AccountController extends Controller
{
    ...
    public function changeInfoUser(Customer $data, UpdateRegisterRequest $request)
    {
    ...
    // tạo tài khoản
    public function store(Request $request, RegisterRequest $message)
    {
        // bắt lỗi
