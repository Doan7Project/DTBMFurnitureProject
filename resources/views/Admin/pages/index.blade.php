  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-lg-3 col-6">
        ...
        <?php 
          $count = 0;
          foreach ($orderMaster as $key => $orderMasters):
          if ($orderMasters->status == 0) {
            $count++;
          }
        ...
        <?php 
                ...
                if( $orderDetails->product_id == $orderDetails->products->id):
                $countOderDetails++;
                $total += $orderDetails->products->price * $orderDetails->quantity;
        endif;
        ...
        <div class="small-box bg-info">
          ...
          <a href="{{url('Admin/pages/Order_list')}}" class="small-box-footer">More info <i
      ...
      <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-success">
          ...
          <a href="{{url('Admin/pages/report')}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
        </div>
      </div>
      <!-- ./col -->
      <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-warning">
          ...
          <a href="{{url('/customer/list')}}" class="small-box-footer">More info <i
              class="fas fa-arrow-circle-right"></i></a>
        </div>
      </div>
      <!-- ./col -->
      <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-danger">
          ...
          <a href="{{url('Admin/pages/Feedback_list')}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
        </div>
      </div>
      <!-- ./col -->
    </div>
          ...
          <div class="card-body">
            <div class="tab-content p-0">
              ...
              <div class="chart tab-pane active" id="revenue-chart" style="position: relative; height: 300px;">
                ...
                <canvas id="revenue-chart-canvas" height="300" style="height: 300px; display: block; width: 793px;"
                  width="793" class="chartjs-render-monitor"></canvas>
              </div>
        ...
        <div class="card bg-gradient-primary">
          ...
          <div class="card-body">
            <div id="world-map"
              ...
              <svg width="543" height="250">
                <g transform="scale(0.42158516020236086) translate(164.49800000000005, 0)">
                  <path
        ...
        <div class="card bg-gradient-info">
          ...
          <div class="card-body">
            ...
            <canvas class="chart chartjs-render-monitor" id="line-chart"
              style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 793px;"
              width="793" height="250"></canvas>
          </div>
          <!-- /.card-body -->
          <div class="card-footer bg-transparent">
            <div class="row">
                        ...
                        <table class="table table-sm">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td data-action="selectDay" data-day="11/15/2022" class="day active today">15</td>
                            ...
                            <tr>
                              ...
                              <td data-action="selectDay" data-day="11/29/2022" class="day">29</td>
                        ...
                        <table class="table-condensed">
                          <thead>
                            <tr>
                              ...
                              <th class="picker-switch" data-action="pickerSwitch" colspan="5" title="Select Year">2022
                              </th>
                              <th class="next" data-action="next"><span class="fa fa-chevron-right"
                          ...
                          <tbody>
                            <tr>
                              <td colspan="7"><span data-action="selectMonth" class="month">Jan</span><span
                                  ...
                                  data-action="selectMonth" class="month active">Nov</span><span
                          ...
                          <tbody>
                            <tr>
                              <td colspan="7"><span data-action="selectYear" class="year old">2019</span><span
                                  ...
                                  class="year">2023</span><span data-action="selectYear" class="year">2024</span><span
                                  data-action="selectYear" class="year">2025</span><span data-action="selectYear"
                                  class="year">2026</span><span data-action="selectYear" class="year">2027</span><span
                                  data-action="selectYear" class="year">2028</span><span data-action="selectYear"
                                  class="year">2029</span><span data-action="selectYear" class="year old">2030</span>
                              </td>
                            </tr>
                          </tbody>
                        </table>
