                ...
                <ul class="navbar-nav justify-content-start flex-grow-1 pe-3">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="parentdropdown dropdown-menu">
                            <h5 class="px-4  p-2"><a href="{{ route('product') }}"
                                    class="text-decoration-none text-white-50"><i class="bi bi-shop pe-2"></i>Visit
                                    Furniture Store </a>
                                </h3>
                                @foreach ($category as $data)
                                <li>
                                    <a class="rotateIcon dropdown-item   pt-2 pb-2"
                                        href="{{ url("/searchProduct/{$data->id}") }}">{{
                    $data->CategoryName }}
                                    </a>
                                </li>
                                @endforeach
                        ...
                        <li class="nav-item dropdown d-none">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                                aria-expanded="false"><i
                                    class="bi bi-person-circle pe-1"></i>{{session('LoggedUser') }}</a>
